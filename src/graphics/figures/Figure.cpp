...
Figure::Figure(std::shared_ptr<FigureData> figure_data,
               std::shared_ptr<Shader> shader)
    : figure_data_(figure_data), shader_(shader) {
  ...
  GLfloat fovy(45.0f), aspect(1.0f), near(0.1f), far(10000.0f);
...
glm::vec3 Figure::GetPosition() const { return glm::vec3(); }
